  ...
  <nav class="navbar navbar-default-coord col-md-8 col-md-offset-2" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bar1">
      <ul class="nav navbar-nav">
        ...
        <li class="{{ Route::currentRouteNamed('cadastra.area.pos') ? 'active' : '' }}"><a href="{{ route('cadastra.area.pos') }}">Cadastrar novo Curso</a></li>
        <li class="{{ Route::currentRouteNamed('editar.area.pos') ? 'active' : '' }}"><a href="{{ route('editar.area.pos') }}">Editar Curso</a></li>
